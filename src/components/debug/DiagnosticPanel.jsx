...
export default function DiagnosticPanel({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 p-2 sm:p-4">
      <div className="flex h-[96vh] w-full max-w-5xl flex-col overflow-hidden rounded-xl border border-border bg-background shadow-2xl">
        ...
        {hasRenderingWarning && (
          <div className="mx-4 mt-3 flex items-start gap-2 rounded-lg border border-amber-500/40 bg-amber-500/10 p-3 text-sm">
        ...
        <div className="min-h-0 flex-1 p-3 sm:p-4">
          <textarea
            ...
            value={report}
            spellCheck={false}
            className="h-full min-h-[300px] w-full resize-none rounded-lg border border-border bg-muted/30 p-3 font-mono text-xs leading-relaxed outline-none focus:ring-2 focus:ring-ring"
