 ...
 * AlertPanel
 *
 * Lista os alertas entre eventos de fogo e
...
function focusAlertOnMap(alert) {
  if (!alert?.eventId) {
    console.warn(
      ...
      <div className="flex-1 overflow-y-auto">
        {alerts.length === 0 ? (
          <div className="p-4 text-center text-xs text-muted-foreground">
            Nenhum alerta ativo. Os alertas são calculados entre eventos de fogo
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-0.5 flex items-center gap-1.5">
                    <Shield className="h-3 w-3 flex-shrink-0 text-green-600" />
