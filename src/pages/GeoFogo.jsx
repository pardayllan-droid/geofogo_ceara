...
export default function GeoFogo() {
  ...
  return (
    <AppShell
      ...
      finishFieldTrail={
        geo.finishFieldTrail
      }
      addFieldPoint={
        geo.addFieldPoint
      }
      addFieldPointAtCoordinates={
        geo.addFieldPointAtCoordinates
      }
      getFieldMissionRecords={
        geo.getFieldMissionRecords
      }
      getUnassignedFieldRecords={
        geo.getUnassignedFieldRecords
      }
      toggleFieldTrailVisibility={
        geo.toggleFieldTrailVisibility
      }
      ...
      deleteFieldPoint={
        geo.deleteFieldPoint
      }
      createFieldMission={
        geo.createFieldMission
      }
      setActiveFieldMission={
        geo.setActiveFieldMission
      }
      clearActiveFieldMission={
        geo.clearActiveFieldMission
      }
      toggleFieldMissionVisibility={
        geo.toggleFieldMissionVisibility
      }
      deleteFieldMission={
        geo.deleteFieldMission
      }
      closePopup={
        geo.closePopup
      }
